describe("Flujo para medio de pago Nequi error", () => {
  before(() => {
  ...
  it("Medio de pago nequi error", () => {
    cy.fixture("medio_pago_nequi_error.json").then((data) => {
    ...
    cy.get(".submit-button").contains("Continuar con tu pago").click();
    cy.wait(10000);
    cy.get(".src-components-App-__App__title__Y13rn").should("contain", "Transacción con error (Nequi)");
    cy.get(".src-components-Summary-__Summary__statusMessage__Y69I7").should("contain", "Número no válido en Sandbox");
