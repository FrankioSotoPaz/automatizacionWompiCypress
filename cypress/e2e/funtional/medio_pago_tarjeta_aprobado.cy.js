describe("Flujo para medio de pago tarjeta aprobado", () => {
  before(() => {
  ...
  it("Medio de pago tarjeta aprobada", () => {
    cy.fixture("medio_pago_tarjeta_aprobado.json").then((data) => {
    ...
    cy.get(".submit-button").contains("Continuar con tu pago").click();
    cy.wait(15000);
    cy.get(".src-components-App-__App__title__Y13rn").should("contain", "Transacción aprobada (Tarjetas)");
